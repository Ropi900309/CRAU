Public Class MedidasCRUB
    ...
    Public Sub LlenarGrid() Implements GripMethod.LlenarGrid
        Dim pro As New DAOMedida

        Dim resultado As List(Of Medida) = pro.ListarTodos()
        ...
        With ListProductos
            ...
            For Each row As Medida In resultado
                .Rows.Add(1)
                .Item(0, i).Value = row.Id
                .Item(1, i).Value = row.Id
                .Item(2, i).Value = row.Medida
    ...
    Private Sub btnSeleccionar_Click(sender As Object, e As EventArgs) Handles btnSeleccionar.Click
        Try
            With ListProductos
                ...
                recibview.comboMedida.SelectedValue = .Item(0, .CurrentRow.Index).Value
    ...
    Private Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
        Try
            With ListProductos
                ...
                cat.Medida = .Item(2, .CurrentRow.Index).Value
                cat.Eliminado = .Item(3, .CurrentRow.Index).Value

                textNombre.Text = cat.Medida
            End With
        Catch ex As Exception
            MsgBox(ex.Message, vbCritical, "Error")
        End Try
