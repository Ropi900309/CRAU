Public Class PuestosCRUB
    ...
    Public Sub CrearGrid() Implements GripMethod.CrearGrid
        ...
        Dim pro As New DAOPuesto
        pro.Eliminado = 0
        Dim resultado As List(Of Puesto) = pro.ListarTodos()
        ...
        Dim i As Integer = 0
            ...
            For Each row As Puesto In resultado
                .Rows.Add(1)
                .Item(0, i).Value = row.Id
                .Item(1, i).Value = row.Id
                .Item(2, i).Value = row.Puesto
        ...
        Private Sub btnSeleccionar_Click(sender As Object, e As EventArgs) Handles btnSeleccionar.Click
            Try
                ...
                recibview.comboPuesto.SelectedValue = .Item(0, .CurrentRow.Index).Value
        ...
        Private Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
            Try
                ...
                cat.Puesto = .Item(2, .CurrentRow.Index).Value
                cat.Eliminado = .Item(3, .CurrentRow.Index).Value

                textNombre.Text = cat.Puesto
            End With
            Catch ex As Exception
                MsgBox(ex.Message, vbCritical, "Error")
            End Try
