Public Class DepartamentosCRUB
    Implements GripMethod
    Public Shared Property recibview As EmpleadosCRUB



    Private cat As New DAODepartamento
    ...
    Public Sub LlenarGrid() Implements GripMethod.LlenarGrid
        Dim pro As New DAODepartamento
        pro.Eliminado = 0
        Dim resultado As List(Of Departamento) = pro.ListarTodos()
        ...
        With ListProductos
            ...
            For Each row As Departamento In resultado
                .Rows.Add(1)
                .Item(0, i).Value = row.Id
                .Item(1, i).Value = row.Id
                .Item(2, i).Value = row.Departamento
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        Try
            cat.Departamento = textNombre.Text
            cat.Eliminado = 0
    ...
    Private Sub btnSeleccionar_Click(sender As Object, e As EventArgs) Handles btnSeleccionar.Click
        Try
            With ListProductos
                ...
                recibview.comboDepto.SelectedValue = .Item(0, .CurrentRow.Index).Value
    ...
    Private Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
        Try
            With ListProductos
                ...
                cat.Departamento = .Item(2, .CurrentRow.Index).Value
                cat.Eliminado = .Item(3, .CurrentRow.Index).Value

                textNombre.Text = cat.Departamento
            End With
        Catch ex As Exception
            MsgBox(ex.Message, vbCritical, "Error")
        End Try
