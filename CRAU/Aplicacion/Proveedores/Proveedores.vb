Public Class Proveedores
    ...
    Private listaProveedores As List(Of Proveedor)
    ...
    Public Sub LlenarGrid() Implements GripMethod.LlenarGrid
        Try
            ...
            With ListProveedores
                ...
                For Each row As Proveedor In resultado
                    .Rows.Add(1)
    ...
    Private Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        Try
            ...
            ProveedorCRUB.pro = pro
            ProveedorCRUB.recibView = Me
            ProveedorCRUB.ShowDialog()
    ...
    Private Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
        Try
            ...
            With ListProveedores
                ...
                pro = listaProveedores(BuscarProveedorLista(pro.Id))
    ...
    Private Function BuscarProveedorLista(id As Integer) As Integer
        ...
        For Each item As Proveedor In listaProveedores
            indice += 1
            If (item.Id = id) Then
                If (indice = 1) Then
                    indice = 0
