Public Class CtipoCRUB
    ...
    Public Sub LlenarGrid() Implements GripMethod.LlenarGrid
        Try
            ...
            Dim resultado As List(Of Ctipo) = tip.ListarTodos()
            ...
            With ListClientes
                ...
                For Each row As Ctipo In resultado
                    .Rows.Add(1)
    ...
    Private Sub CtipoCRUB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            CrearGrid()
            LlenarGrid()
