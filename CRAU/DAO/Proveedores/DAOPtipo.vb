...
Public Class DAOPtipo
    ...
    Public Function ListarTodos() As Object Implements OpSql.ListarTodos
        Dim consulta As New List(Of Ptipo)
        ...
        If r.HasRows Then
            While r.Read()
                ...
                consulta.Add(New Ptipo(r.GetValue((r.GetOrdinal("id"))), ((r.GetValue((r.GetOrdinal("eliminado"))))), r.GetValue((r.GetOrdinal("tipo_asociado")))))
                i += 1
            End While
        End If
        r.Close()
